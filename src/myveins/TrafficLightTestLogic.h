...
namespace veins {
class TrafficLightTestLogic : public TraCITrafficLightAbstractLogic {
private:
...
class TrafficLightTestLogicAccess {
public:
    TrafficLightTestLogic* get(cModule* host)
    {
        TrafficLightTestLogic* traci = FindModule<TrafficLightTestLogic*>::findSubModule(host);
        ASSERT(traci);
        return traci;
    };
};
