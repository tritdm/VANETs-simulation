...
#include "TrafficLightTestLogic.h"

using veins::TrafficLightTestLogic;

Define_Module(veins::TrafficLightTestLogic);

void TrafficLightTestLogic::initialize()
{
    TraCITrafficLightAbstractLogic::initialize();
}

void TrafficLightTestLogic::startChangingProgramAt(simtime_t t)
{
    Enter_Method_Silent();
...
void TrafficLightTestLogic::handleApplMsg(cMessage* msg)
{
    delete msg; // just drop it
}

void TrafficLightTestLogic::handleTlIfMsg(TraCITrafficLightMessage* tlMsg)
{
    delete tlMsg; // just drop it
}
void TrafficLightTestLogic::handleMessage(cMessage* msg)
{
...
void TrafficLightTestLogic::handlePossibleSwitch()
{
}
